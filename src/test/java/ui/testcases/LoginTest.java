...
public class LoginTest extends BaseTestNotLogin {
    ...
    @Test(priority = 2, dataProvider = "data_provider_login_fail_invalid_email", dataProviderClass = DataProviderFactory.class)
    ...
    @Issue("CRM-3")
    @Description("Login with invalid credentials")
    @Test(priority = 3, dataProvider = "data_provider_login_fail_invalid_password", dataProviderClass = DataProviderFactory.class)
