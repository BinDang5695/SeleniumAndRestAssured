...
public class PropertiesHelper {
    ...
    private static String relPropertiesFilePathDefault = "src" + File.separator + "test" + File.separator + "resources" + File.separator + "configs" + File.separator + "ui.properties";
